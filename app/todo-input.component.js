            ...
            TodoInput = (function () {
                function TodoInput(todoService) {
                    ...
                    if (this.todoService.todos.length <= 0) {
                        this.todoService.add(new todo_model_1.TodoModel('eat'));
                        this.todoService.add(new todo_model_1.TodoModel('sleep'));
                        this.todoService.add(new todo_model_1.TodoModel('code :)'));
                    }
                }
                TodoInput.prototype.addItem = function () {
                    this.todoService.add(new todo_model_1.TodoModel(this.newTodo));
                    this.newTodo = '';
                };
